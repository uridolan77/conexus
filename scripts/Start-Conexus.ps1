...
$ConexusDir    = "C:\Dev\code\conexus"
$AdaptationSln = "C:\Dev\code\conexus.adaptation"
$AdaptationApi = "C:\Dev\code\conexus.adaptation\src\Conexus.Adaptation.Api"
...
if (-not $NoAdapt) {
    ...
    $cmd = "& { `$host.UI.RawUI.WindowTitle = 'conexus.adaptation'; Set-Location '$AdaptationSln'; dotnet run --project '$AdaptationApi' --urls http://localhost:5000 }"
