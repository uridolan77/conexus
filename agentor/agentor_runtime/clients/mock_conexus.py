"""In-memory Conexus client for tests and local examples (no HTTP)."""

from __future__ import annotations

from agentor_runtime.clients.conexus import ConexusResponse, ConexusUsage
...
class MockConexusClient:
    """Configurable mock Conexus client (returns canned :class:`ConexusResponse`)."""
